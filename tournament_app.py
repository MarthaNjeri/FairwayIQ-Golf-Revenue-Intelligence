...
# Set up page config for an elite, immersive look
...
try:
    ...
    # UPDATED: Re-aligned fallback array to match the 8-column schema of the scorecard app
    data = {
...
# --- STEP 3: AUTOMATIC COLUMN MATCHING ---
df_scores.columns = df_scores.columns.str.strip()

# Adjusted keywords to map directly to "Score" or "Gross_Score"
...
# --- STEP 4: PROCESS AND MAP DATA SAFELY ---
...
# --- STEP 5: TOURNAMENT STATE MANAGEMENT ---
...
# --- STEP 6: SECURE SIDEBAR CONTROLLER (Hidden completely for Spectators & TVs) ---
if current_view == "standard":
    ...
    if st.sidebar.button("Switch to Read-Only Spectator View"):
        st.query_params["view"] = "spectator"
        st.rerun()
    if st.sidebar.button("Switch to Clubhouse TV Screen View"):
        st.query_params["view"] = "tv"
        st.rerun()

elif current_view in ["spectator", "tv"]:
    if st.sidebar.button("⬅️ Return to Main App"):
        st.query_params.clear()
        st.rerun()

# --- FEATURE 3 IMPLEMENTATION: SUSPENSE MODIFIER ---
...
# =========================================================================
# --- FEATURE 1: CLUBHOUSE TV MODE LAYOUT ---
# =========================================================================
if current_view == "tv":
...
# =========================================================================
# --- STANDARD & FEATURE 2 (SPECTATOR) SYSTEM LAYOUT ---
# =========================================================================
else:
